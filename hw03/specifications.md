...
This file contains two specifications. Each one describes **one Python script** that runs start to finish in a single execution. Build each script exactly as described. Do not combine the two pipelines into one file.
